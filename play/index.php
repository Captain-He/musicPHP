...
<div class="mp">
	<div class="mp-box">
		...
		<div class="mp-menu">
			...
			<a class="close" style="color: #A52a2a;width: 80px;height: 40px;position: absolute;left:130%;top:-35%;z-index: 1000;" href=<?php echo"../first.php?a=".$_GET['a']."&b=".$_GET['b']."&name=".$_GET['user']."&class=".$_GET['class'];?>>返回</a>
		</div>
	</div>
